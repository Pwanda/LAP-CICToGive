...
public class ItemController {
    ...
    public ResponseEntity<Map<String, Object>> getAllItems(
        ...
        try {
            ...
            if (
                ...
                pageItems =
                    itemRepository.findByCategoryAndNameContainingIgnoreCase(
                        category,
                        search,
                        pageable
                    );
                ...
                pageItems = itemRepository.findByNameContainingIgnoreCase(
                    search,
                    pageable
                );
            } else {
    ...
    public ResponseEntity<?> createItem(@RequestBody ItemRequest itemRequest) {
        try {
            ...
            item.setReserved(
                itemRequest.getReserved() != null
                    ? itemRequest.getReserved()
                    : false
            );

            // Add image URLs if provided
            if (
                itemRequest.getImageUrls() != null &&
                !itemRequest.getImageUrls().isEmpty()
            ) {
