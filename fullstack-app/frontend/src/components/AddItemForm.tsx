...
export default function AddItemForm({ editItem, onItemAdded }: AddItemFormProps) {
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="mb-8">
            ...
            <p className="text-sm text-gray-500 mb-4">
              Great photos help your item get noticed. Add up to 5 photos to showcase your item.
            </p>
            ...
            <div 
              ...
              className={`cursor-pointer flex flex-col justify-center items-center px-6 pt-5 pb-6 border-2 ${
                dragActive ? 'border-green-500 bg-green-50' : 'border-gray-300 border-dashed'
              } rounded-lg transition-colors duration-200 ${
                imageUrls.length + images.length >= 5 ? 'opacity-50 cursor-not-allowed' : ''
              }`}
            >
              <div className="space-y-2 text-center">
                ...
                <div className="mt-2 flex items-center justify-center text-sm text-gray-500">
                  <span className="font-medium">{imageUrls.length + images.length}</span>
            ...
            {(imageUrls.length > 0 || imagePreviewUrls.length > 0) && (
              <div className="mt-6">
                <h4 className="text-sm font-medium text-gray-700 mb-3">Your Photos:</h4>
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <div className="mb-5">
              ...
              <input
                ...
                className="block w-full border border-gray-300 rounded-lg shadow-sm py-3 px-4 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              ...
              <div className="mb-5">
                ...
                <select
                  ...
                  className="block w-full bg-white border border-gray-300 rounded-lg shadow-sm py-3 px-4 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
                  required
                >
                  {CATEGORIES.map((cat) => (
            ...
            <div className="mb-5">
              ...
              <div className="mt-1 relative rounded-md shadow-sm">
                ...
                <input
                  ...
                  className="block w-full pl-10 border border-gray-300 rounded-lg shadow-sm py-3 px-4 focus:outline-none focus:ring-green-500 focus:border-green-500 sm:text-sm"
          ...
          <div className="border-t border-gray-200 pt-6">
            ...
            <p className="mt-4 text-sm text-gray-500 text-center">
              By listing an item, you agree to our terms of service and privacy policy.
            </p>
          </div>
        </form>
      </div>
