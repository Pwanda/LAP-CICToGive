        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          {items.length === 0 ? (
            <div className="bg-white p-8 rounded-lg shadow-md text-center">
              ...
              <p className="mt-1 text-gray-500">Get started by creating a new item listing.</p>
              <div className="mt-6">
                <Link 
                  href="/items/new" 
                      ...
                      <div className="min-w-0 flex-1 flex items-center">
                        ...
                        <div className="ml-4 flex-1">
                          <div className="flex items-center justify-between">
                            <p className="text-lg font-medium text-blue-600 truncate">{item.name}</p>
                            <p className="ml-2 flex-shrink-0 font-semibold text-green-600">{formatPrice(item.price || 0)}</p>
                          </div>
